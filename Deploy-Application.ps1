...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "BeerSmith2_3_12.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$envProgramFilesX86\BeerSmith2\Uninstall.exe" -Parameters "/S" -WindowStyle "Hidden" -PassThru
		##*===============================================
		##* POST-UNINSTALLATION
		##*===============================================
